...
## --------------------- Modeling ---------------------------- ##
os.makedirs('models', exist_ok=True)  # Création du dossier models
...
def train_model(X_train, y_train, plot_name='', class_weight=None):
    ...
    model_filename = f'models/{clf_name}_{plot_name}.pkl'
    ...
    with open('metrics.txt', 'a') as f:
        ...
        f.write(f"F1-score of Training: {score_train*100:.2f}%\n")
        f.write(f"F1-score of Validation: {score_test*100:.2f}%\n")
        f.write('----'*10 + '\n')
...
# Delete old individual confusion matrices
